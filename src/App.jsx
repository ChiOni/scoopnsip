  ...
  async function handleAIAutoFill() {
    ...
    try {
      ...
      const updatedWine = {
        ...
        // country와 wineCategory는 사용자가 선택한 값 유지 (AI 결과로 덮어쓰지 않음)
        country: newWine.country,
        wineCategory: newWine.wineCategory,
  ...
  async function handleCreateWine() {
    ...
    try {
      const wine = {
        ...
        country: newWine.country,
        wineCategory: newWine.wineCategory || 'Red',
  ...
  async function handleEditWine() {
    ...
    try {
      const updatedWine = {
        ...
        wineCategory: editWine.wineCategory || 'Red',
